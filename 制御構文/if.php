...
print '<br/>';
//4.1.9 値を返す新しい「switch」──match式
/*
PHP8では、いわゆる「値を返せるswitch」としてmatch式が導入されました。
値が返せるとは、たとえばmatch式の結果を変数に代入したり、引数として渡せるということです。
*/
$rank = '甲';
$result = match($rank){
    '甲' => '大変良いです。',
